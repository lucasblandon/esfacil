...
class Cart extends CartCore
{
	...
	function checkDiscountValidity($discountObj, $discounts, $order_total, $products, $checkCartDiscount = false)
	{
		...
		if(!Module::isInstalled('agilemultipleseller'))return parent::checkDiscountValidity($discountObj, $discounts, $order_total, $products, $checkCartDiscount);
        include_once(_PS_ROOT_DIR_  . "/modules/agilemultipleseller/agilemultipleseller.php");
		if($valid_err = AgileMultipleSeller::validate_coupon_error($discountObj))return $valid_err;
