...
<script type="text/javascript" src="{$base_dir_ssl}js/jquery/plugins/ajaxfileupload/jquery.ajaxfileupload.js"></script>
<link href="{$base_dir_ssl}js/jquery/plugins/ajaxfileupload/jquery.ajaxfileupload.css" rel="stylesheet" type="text/css" media="all" />
