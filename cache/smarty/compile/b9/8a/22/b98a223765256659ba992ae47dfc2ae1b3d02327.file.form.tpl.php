<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:46:29
         compiled from "/home/cooltivoinfo/public_html/modules/agilesellerlistoptions/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:184595471754cf9bd5e5d513-39623707%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b98a223765256659ba992ae47dfc2ae1b3d02327' => 
    array (
      0 => '/home/cooltivoinfo/public_html/modules/agilesellerlistoptions/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1422889785,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '184595471754cf9bd5e5d513-39623707',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cf9bd6d72f77_44717557',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cf9bd6d72f77_44717557')) {function content_54cf9bd6d72f77_44717557($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
   ...
   <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='agile_text_select') {?>
   <div class="row">
...
<?php }?>" />
		...
		<span class="col-sm-3 col-md-2">
			<select name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['select_name'], ENT_QUOTES, 'utf-8', true);?>
"
					id="<?php if (isset($_smarty_tpl->tpl_vars['input']->value['select_id'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['select_id'], ENT_QUOTES, 'utf-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['select_name'], ENT_QUOTES, 'utf-8', true);?>
<?php }?>">
...
"
							<?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['select_name']]==$_smarty_tpl->tpl_vars['option']->value->{$_smarty_tpl->tpl_vars['input']->value['options']['id']}) {?>
								selected="selected"
							<?php }?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '184595471754cf9bd5e5d513-39623707');
content_54cf9bd6954485_96233975($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:46:30
         compiled from "/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54cf9bd6954485_96233975')) {function content_54cf9bd6954485_96233975($_smarty_tpl) {?>
