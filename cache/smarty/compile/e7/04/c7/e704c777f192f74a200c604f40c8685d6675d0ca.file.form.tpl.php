<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:43:26
         compiled from "/home/cooltivoinfo/public_html/modules/agilemembership/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:179776234554cf9b1e953366-07983149%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e704c777f192f74a200c604f40c8685d6675d0ca' => 
    array (
      0 => '/home/cooltivoinfo/public_html/modules/agilemembership/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1422889317,
      2 => 'file',
    ),
    '54b1137c9458bf95662f0cbb8b600c763a1f4d9d' => 
    array (
      0 => '/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/helpers/form/form.tpl',
      1 => 1420643154,
      2 => 'file',
    ),
    '96bc1a2bbbcc7b588c0049558d08cb36bd7eefc6' => 
    array (
      0 => '/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/helpers/form/form_group.tpl',
      1 => 1420643154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179776234554cf9b1e953366-07983149',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cf9b1f9dd6f7_35434357',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cf9b1f9dd6f7_35434357')) {function content_54cf9b1f9dd6f7_35434357($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.counter.php';
?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='agile-fee_validity') {?>
		<div class="table-responsive clearfix sep col-lg-<?php if (isset($_smarty_tpl->tpl_vars['input']->value['col'])) {?><?php echo intval($_smarty_tpl->tpl_vars['input']->value['col']);?>
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
 ...
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['header']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['head']->key => $_smarty_tpl->tpl_vars['head']->value) {
$_smarty_tpl->tpl_vars['head']->_loop = true;
?>
					<th class="<?php echo $_smarty_tpl->tpl_vars['head']->value['class'];?>
"><?php echo $_smarty_tpl->tpl_vars['head']->value['name'];?>
</th>
				<?php } ?>
				<?php if ($_smarty_tpl->tpl_vars['input']->value['isAgileMultipleSellerInstalled']==1) {?><th class="col-lg-1"><?php echo $_smarty_tpl->tpl_vars['input']->value['maxListing'];?>
</th><?php }?>
				</tr></thead>
				<tbody>
				<?php  $_smarty_tpl->tpl_vars['body'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['body']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['body']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['body']->key => $_smarty_tpl->tpl_vars['body']->value) {
$_smarty_tpl->tpl_vars['body']->_loop = true;
?>
				<tr>
				<td><?php echo $_smarty_tpl->tpl_vars['body']->value['membertype'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['body']->value['Fees'];?>
</td>
				<td>
					<div class="row">
					<div class="col-xs-4 cole-sm-3 col-md-2">
					<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_units" id="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_units" value="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['units'];?>
" size="3" />
					</div>
					<select name="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_interval" id="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_member_interval" class="col-xs-7 cole-sm-8 col-md-6">
					<?php  $_smarty_tpl->tpl_vars['interval'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['interval']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['membership_interval']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
					    <option value="<?php echo $_smarty_tpl->tpl_vars['interval']->value['id'];?>
" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['interval']->value['id'];?>
<?php $_tmp4=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['body']->value['id_product']['interval']==$_tmp4) {?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['interval']->value['name'];?>
</option>
					<?php } ?>
					</select>
					</div>
				...
				<td>
					<select name="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_id_group" id="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_id_group">
					<?php  $_smarty_tpl->tpl_vars['group'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['group']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['groups']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['group']->key => $_smarty_tpl->tpl_vars['group']->value) {
$_smarty_tpl->tpl_vars['group']->_loop = true;
?>
					    <option value="<?php echo $_smarty_tpl->tpl_vars['group']->value['id'];?>
" <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['group']->value['id'];?>
<?php $_tmp5=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['body']->value['id_product']['group']==$_tmp5) {?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['group']->value['name'];?>
</option>
					<?php } ?>
					</select>
				</td>
				<?php if ($_smarty_tpl->tpl_vars['input']->value['isAgileMultipleSellerInstalled']==1) {?><td>
					<input type="text" name="<?php echo $_smarty_tpl->tpl_vars['body']->value['id_product']['name'];?>
_listing_max" value="<?php echo $_smarty_tpl->tpl_vars['body']->value['listing_max'];?>
" size="5" />
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
   ...
   <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='agile_condition_radio') {?>
...
"<?php if (isset($_smarty_tpl->tpl_vars['value']->value['onchange'])) {?> onchange="<?php echo $_smarty_tpl->tpl_vars['value']->value['onchange'];?>
" <?php }?><?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]==$_smarty_tpl->tpl_vars['value']->value['value']) {?> checked="checked"<?php }?><?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?> disabled="disabled"<?php }?>/><?php echo $_smarty_tpl->tpl_vars['value']->value['label'];?>
</label>
				<?php if (isset($_smarty_tpl->tpl_vars['value']->value['condfields'])) {?>
					<div id="membership_voucher_validity" class="row" style="margin-top:1em"> <span class="col-sm-2 col-md-1"><?php echo $_smarty_tpl->tpl_vars['value']->value['condfields']['label'];?>
</span>
						<?php  $_smarty_tpl->tpl_vars['condfield'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['condfield']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['value']->value['condfields']['fieldvalues']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['condfield']->key => $_smarty_tpl->tpl_vars['condfield']->value) {
$_smarty_tpl->tpl_vars['condfield']->_loop = true;
?>
							<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['condfield']->value['name'];?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['value_text'] = new Smarty_variable($_smarty_tpl->tpl_vars['fields_value']->value[$_tmp1], null, 0);?>
							<?php if ($_smarty_tpl->tpl_vars['condfield']->value['type']=='text') {?>
								<span class="col-sm-1">
								<input type="text"
									name="<?php echo $_smarty_tpl->tpl_vars['condfield']->value['name'];?>
"
									id="<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['id'])) {?><?php echo $_smarty_tpl->tpl_vars['input']->value['id'];?>
<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['condfield']->value['name'];?>
<?php }?>"
									<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['size'])) {?> size="<?php echo $_smarty_tpl->tpl_vars['condfield']->value['size'];?>
"<?php }?>
									value="<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['string_format'])&&$_smarty_tpl->tpl_vars['condfield']->value['string_format']) {?><?php echo htmlspecialchars(sprintf($_smarty_tpl->tpl_vars['condfield']->value['string_format'],$_smarty_tpl->tpl_vars['value_text']->value), ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value_text']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" />
								</span>
							<?php } elseif ($_smarty_tpl->tpl_vars['condfield']->value['type']=='select') {?>
								<span class="col-sm-3 col-md-2">
									<select name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condfield']->value['name'], ENT_QUOTES, 'utf-8', true);?>
"
											id="<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['id'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condfield']->value['id'], ENT_QUOTES, 'utf-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condfield']->value['name'], ENT_QUOTES, 'utf-8', true);?>
<?php }?>"
											<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['multiple'])) {?>multiple="multiple" <?php }?>
											<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['size'])) {?>size="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['condfield']->value['size'], ENT_QUOTES, 'utf-8', true);?>
"<?php }?>>
											<?php  $_smarty_tpl->tpl_vars['option'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['option']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['condfield']->value['options']['query']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['option']->key => $_smarty_tpl->tpl_vars['option']->value) {
$_smarty_tpl->tpl_vars['option']->_loop = true;
?>
												<?php if (is_object($_smarty_tpl->tpl_vars['option']->value)) {?>
													<option value="<?php echo $_smarty_tpl->tpl_vars['option']->value->{$_smarty_tpl->tpl_vars['condfield']->value['options']['id']};?>
"
 ...
 $_from = $_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['condfield']->value['name']]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
																<?php if ($_smarty_tpl->tpl_vars['field_value']->value==$_smarty_tpl->tpl_vars['option']->value->{$_smarty_tpl->tpl_vars['condfield']->value['options']['id']}) {?>
																	selected="selected"
																<?php }?>
															<?php } ?>
														<?php } else { ?>
															<?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['condfield']->value['name']]==$_smarty_tpl->tpl_vars['option']->value->{$_smarty_tpl->tpl_vars['condfield']->value['options']['id']}) {?>
																selected="selected"
															<?php }?>
														<?php }?>
													><?php echo $_smarty_tpl->tpl_vars['option']->value->{$_smarty_tpl->tpl_vars['condfield']->value['options']['name']};?>
</option>
												...
												<?php } else { ?>
													<option value="<?php echo $_smarty_tpl->tpl_vars['option']->value[$_smarty_tpl->tpl_vars['condfield']->value['options']['id']];?>
"
														<?php if (isset($_smarty_tpl->tpl_vars['condfield']->value['multiple'])) {?>
															<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['condfield']->value['name'];?>
<?php $_tmp2=ob_get_clean();?><?php  $_smarty_tpl->tpl_vars['field_value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_value']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['fields_value']->value[$_tmp2]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['field_value']->key => $_smarty_tpl->tpl_vars['field_value']->value) {
$_smarty_tpl->tpl_vars['field_value']->_loop = true;
?>
																<?php if ($_smarty_tpl->tpl_vars['field_value']->value==$_smarty_tpl->tpl_vars['option']->value[$_smarty_tpl->tpl_vars['condfield']->value['options']['id']]) {?>
		...
		<?php } ?>
   <?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='checkboxgroup') {?>
		<?php $_smarty_tpl->tpl_vars['idx'] = new Smarty_variable(0, null, 0);?>
		<?php $_smarty_tpl->tpl_vars['remainder'] = new Smarty_variable(count($_smarty_tpl->tpl_vars['input']->value['values']['default'])%4, null, 0);?>
		<div class="table-responsive clearfix">
       	<table class="table std">
			<?php  $_smarty_tpl->tpl_vars['pg'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['pg']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['default']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['pg']->key => $_smarty_tpl->tpl_vars['pg']->value) {
$_smarty_tpl->tpl_vars['pg']->_loop = true;
?>
				<?php if (($_smarty_tpl->tpl_vars['idx']->value%4)==0) {?>
               		<tr>
				<?php }?>
				<td class="col-sm-3"><input type="checkbox" name="<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['pg']->value['value'];?>
" <?php if ($_smarty_tpl->tpl_vars['pg']->value['checked']) {?> checked <?php }?> />&nbsp;<?php echo $_smarty_tpl->tpl_vars['pg']->value['label'];?>
 </td>
				<?php $_smarty_tpl->_capture_stack[0][] = array('default', 'idx', null); ob_start(); ?><?php echo $_smarty_tpl->tpl_vars['idx']->value+1;?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
			...
			<?php } ?>
			<?php if ($_smarty_tpl->tpl_vars['remainder']->value>0) {?>
				<?php if ($_smarty_tpl->tpl_vars['remainder']->value==1) {?> 
					<td class="col-sm-3"></td><td class="col-sm-3"></td><td class="col-sm-3"></td>
				<?php } elseif ($_smarty_tpl->tpl_vars['remainder']->value==2) {?>
					<td class="col-sm-3"></td><td class="col-sm-3"></td>
				<?php } elseif ($_smarty_tpl->tpl_vars['remainder']->value==3) {?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['input']->value['values']['others'])&&$_smarty_tpl->tpl_vars['input']->value['values']['others']) {?>
			<p><?php echo $_smarty_tpl->tpl_vars['input']->value['values']['others']['header'];?>
</p>
			<textarea name="<?php echo $_smarty_tpl->tpl_vars['input']->value['values']['others']['name'];?>
" ><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['input']->value['values']['others']['name'];?>
<?php $_tmp3=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['fields_value']->value[$_tmp3];?>
</textarea>
		<?php }?>
    <?php } else { ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '179776234554cf9b1e953366-07983149');
content_54cf9b1f423782_39576682($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:43:27
         compiled from "/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54cf9b1f423782_39576682')) {function content_54cf9b1f423782_39576682($_smarty_tpl) {?>
