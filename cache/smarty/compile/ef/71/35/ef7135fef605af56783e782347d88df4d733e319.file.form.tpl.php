<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:48:28
         compiled from "/home/cooltivoinfo/public_html/modules/agilesellerratings/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:113976727654cf9c4c28e012-14279053%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ef7135fef605af56783e782347d88df4d733e319' => 
    array (
      0 => '/home/cooltivoinfo/public_html/modules/agilesellerratings/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1422890782,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '113976727654cf9c4c28e012-14279053',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cf9c4d0ed213_21205560',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cf9c4d0ed213_21205560')) {function content_54cf9c4d0ed213_21205560($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.counter.php';
?>
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='placeholder') {?>
		<div class="panel col-sm-12 col-md-6 col-lg-6">
			<div id="<?php echo $_smarty_tpl->tpl_vars['input']->value['name'];?>
"></div>
			<div class="panel-footer" style="text-align:center">
				<button type="submit" value="1" id="<?php echo $_smarty_tpl->tpl_vars['input']->value['submit_name'];?>
" name="<?php echo $_smarty_tpl->tpl_vars['input']->value['submit_name'];?>
" class="btn btn-default">
					<i class="process-icon-save"></i> <?php echo $_smarty_tpl->tpl_vars['input']->value['submit_label'];?>

				</button>
			</div>
		</div>   
	<?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='criterions') {?>
		<div class="panel col-sm-12 col-md-6 col-lg-6">
		<table class="table">
		<thead><tr>
		<th><?php echo $_smarty_tpl->tpl_vars['input']->value['title_actions'];?>
</th><th><?php echo $_smarty_tpl->tpl_vars['input']->value['title_Criterion'];?>
</th>
		</tr></thead>
		<tbody>
...
?>
		<tr><td>
			<a href="javascript:;" onclick="fill_criteria_edit_form(<?php echo $_smarty_tpl->tpl_vars['criterion']->value['id'];?>
);" class="edit btn btn-default">
				<i class="icon-pencil"></i><?php echo $_smarty_tpl->tpl_vars['input']->value['edit_action'];?>

			</a>
			<a href="javascript:;" onclick="deleteCriterion(<?php echo $_smarty_tpl->tpl_vars['criterion']->value['id'];?>
,'<?php echo $_smarty_tpl->tpl_vars['input']->value['delete_warning_msg'];?>
');" class="delete  btn btn-default">
				<i class="icon-trash"></i><?php echo $_smarty_tpl->tpl_vars['input']->value['delete_action'];?>

			</a>
		</td><td><?php echo $_smarty_tpl->tpl_vars['criterion']->value['name'];?>
</td></tr>
		<?php } ?>
		</tbody>
		</table>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '113976727654cf9c4c28e012-14279053');
content_54cf9c4cc8dc46_20367101($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_54cf9c4cc8dc46_20367101')) {function content_54cf9c4cc8dc46_20367101($_smarty_tpl) {?>
