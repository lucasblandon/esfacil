<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 09:59:56
         compiled from "/home/cooltivoinfo/public_html/themes/electronic/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:75908196454cf90ec877234-98316747%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1cb9188de0f604edd11638c48aed9a8c9197f3b' => 
    array (
      0 => '/home/cooltivoinfo/public_html/themes/electronic/modules/blockcart/blockcart-json.tpl',
      1 => 1422888326,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '75908196454cf90ec877234-98316747',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cf90eca56180_90733833',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cf90eca56180_90733833')) {function content_54cf90eca56180_90733833($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/modifier.replace.php';
?>
{
"products": [
...
",
		"image_url":          "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'pos_product'), ENT_QUOTES, 'ISO-8859-1', true);?>
",	
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>",
		"name":          "<?php echo htmlentities($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8'),15,'...',true), ENT_QUOTES, 'ISO-8859-1', true);?>
",
...
",
		"link":            "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true,null,"deleteDiscount=".((string)$_smarty_tpl->tpl_vars['discount']->value['id_discount'])), ENT_QUOTES, 'ISO-8859-1', true);?>
",
