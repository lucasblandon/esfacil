<?php /* Smarty version Smarty-3.1.19, created on 2015-02-03 09:09:02
         compiled from "/home/cooltivoinfo/public_html/themes/electronic/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:45818616554d0d67ee16727-34056385%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56d7549cb6d9620e9f31c9cb03aa77ef2fad9967' => 
    array (
      0 => '/home/cooltivoinfo/public_html/themes/electronic/contact-form.tpl',
      1 => 1422887805,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '45818616554d0d67ee16727-34056385',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d0d67f0302d1_62409307',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d0d67f0302d1_62409307')) {function content_54d0d67f0302d1_62409307($_smarty_tpl) {?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['contact']->value['id_contact']==$_smarty_tpl->tpl_vars['customerThread']->value['id_contact']) {?>
						<input type="text" id="contact_name" name="contact_name" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['contact']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" readonly="readonly" />
...
" <?php if (isset($_POST['id_contact'])&&$_POST['id_contact']==$_smarty_tpl->tpl_vars['contact']->value['id_contact']) {?>selected="selected"<?php }?>><?php echo htmlentities($_smarty_tpl->tpl_vars['contact']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
				<?php } ?>
				</select>
			</p>
...
" class="desc_contact" style="display:none;">
						<?php echo htmlentities($_smarty_tpl->tpl_vars['contact']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
			...
			<p class="text">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['email'])) {?>
					<input type="text" id="email" name="from" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['customerThread']->value['email'], ENT_QUOTES, 'UTF-8', true);?>
" readonly="readonly" />
				<?php } else { ?>
					<input type="text" id="email" name="from" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['email']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
				<?php }?>
			</p>
...
" <?php if (intval($_smarty_tpl->tpl_vars['order']->value['selected'])) {?>selected="selected"<?php }?>><?php echo htmlentities($_smarty_tpl->tpl_vars['order']->value['label'], ENT_QUOTES, 'UTF-8', true);?>
</option>
						<?php } ?>
					</select>
...
"><?php echo htmlentities($_smarty_tpl->tpl_vars['product']->value['label'], ENT_QUOTES, 'UTF-8', true);?>
</option>
						<?php } ?>
					</select>
				<?php } ?>
...
" readonly="readonly" />
		...
		<p class="textarea">
			<label for="message"><?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
			 ...
			 <textarea id="message" name="message" rows="15" cols="10"><?php if (isset($_smarty_tpl->tpl_vars['message']->value)) {?><?php echo stripslashes(htmlentities($_smarty_tpl->tpl_vars['message']->value, ENT_QUOTES, 'UTF-8', true));?>
<?php }?></textarea>
		</p>
		<p class="submit">
