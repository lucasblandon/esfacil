<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:42:42
         compiled from "/home/cooltivoinfo/public_html/modules/agilemultipleseller/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204171863754cf9af29a6576-58391082%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd97c0d7e933d60bf096ce2ae01c912fc071d160' => 
    array (
      0 => '/home/cooltivoinfo/public_html/modules/agilemultipleseller/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1422891062,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '204171863754cf9af29a6576-58391082',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cf9af390e9c0_15508718',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cf9af390e9c0_15508718')) {function content_54cf9af390e9c0_15508718($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.counter.php';
?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='htmlhr') {?>
		<div class="sep col-lg-<?php if (isset($_smarty_tpl->tpl_vars['input']->value['col'])) {?><?php echo intval($_smarty_tpl->tpl_vars['input']->value['col']);?>
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='radio'&&isset($_smarty_tpl->tpl_vars['input']->value['header'])&&$_smarty_tpl->tpl_vars['input']->value['header']) {?> 
		<p class="help-block">
			<?php if (is_array($_smarty_tpl->tpl_vars['input']->value['header'])) {?>
				<?php  $_smarty_tpl->tpl_vars['p'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['p']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['header']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value) {
$_smarty_tpl->tpl_vars['p']->_loop = true;
?>
					<?php if (is_array($_smarty_tpl->tpl_vars['p']->value)) {?>
						<span class="<?php echo $_smarty_tpl->tpl_vars['p']->value['class'];?>
...
<br />
				...
				<?php } ?>
			<?php } else { ?>
				<?php echo $_smarty_tpl->tpl_vars['input']->value['header'];?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '204171863754cf9af29a6576-58391082');
content_54cf9af344dab1_29993177($_smarty_tpl);
...
" />
   ...
   <?php } elseif ($_smarty_tpl->tpl_vars['input']->value['type']=='agile_radio') {?>
		<?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value) {
$_smarty_tpl->tpl_vars['value']->_loop = true;
...
"<?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]==$_smarty_tpl->tpl_vars['value']->value['value']) {?> checked="checked"<?php }?><?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?> disabled="disabled"<?php }?>/><?php echo $_smarty_tpl->tpl_vars['value']->value['label'];?>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['value']->value['p'])) {?>
				<p class="help-block">
				<?php if (is_array($_smarty_tpl->tpl_vars['value']->value['p'])) {?>
					<?php  $_smarty_tpl->tpl_vars['p'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['p']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['value']->value['p']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value) {
$_smarty_tpl->tpl_vars['p']->_loop = true;
?>
						<?php if (is_array($_smarty_tpl->tpl_vars['p']->value)) {?>
...
<br />
					...
					<?php } ?>
				<?php } else { ?>
					<?php echo $_smarty_tpl->tpl_vars['value']->value['p'];?>
...
$_smarty_tpl->tpl_vars['value']->_loop = true;
?>
			<div id='<?php echo $_smarty_tpl->tpl_vars['value']->value['section_name'];?>
'>
...
?>
				<input type="checkbox" name="<?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
" id="<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" value="1" <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['item']->value['id']])&&$_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['item']->value['id']]=='1') {?>checked<?php }?>/>&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value['label'];?>
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 10:42:43
         compiled from "/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54cf9af344dab1_29993177')) {function content_54cf9af344dab1_29993177($_smarty_tpl) {?>
