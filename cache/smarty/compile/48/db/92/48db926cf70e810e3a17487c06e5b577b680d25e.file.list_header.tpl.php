<?php /* Smarty version Smarty-3.1.19, created on 2015-02-02 16:34:02
         compiled from "/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/controllers/categories/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3564529954cfed4a8a5b09-54876414%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48db926cf70e810e3a17487c06e5b577b680d25e' => 
    array (
      0 => '/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/controllers/categories/helpers/list/list_header.tpl',
      1 => 1422891147,
      2 => 'file',
    ),
    '802bc2a43606374a545eecc169c5bef264bd939b' => 
    array (
      0 => '/home/cooltivoinfo/public_html/adminpruebas/themes/default/template/helpers/list/list_header.tpl',
      1 => 1420643154,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3564529954cfed4a8a5b09-54876414',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cfed4acd02c1_36537140',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cfed4acd02c1_36537140')) {function content_54cfed4acd02c1_36537140($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.math.php';
?>
...
?>
								<input type="hidden" name="<?php echo htmlentities($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
[]" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['val']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
							<?php } ?>
						<?php } else { ?>
							<input type="hidden" name="<?php echo htmlentities($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['value']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
						<?php }?>
					<?php }?>
				<?php } ?>
...
<?php if (isset($_smarty_tpl->tpl_vars['sql']->value)&&$_smarty_tpl->tpl_vars['sql']->value) {?>
	<form id="sql_form" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminRequestSql'), ENT_QUOTES, 'ISO-8859-1', true);?>
&amp;addrequest_sql" method="post" class="hide">
		<input type="hidden" id="sql_query" name="sql" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['sql']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" />
