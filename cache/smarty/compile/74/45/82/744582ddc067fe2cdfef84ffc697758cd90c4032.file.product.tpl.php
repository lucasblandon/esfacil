<?php /* Smarty version Smarty-3.1.19, created on 2015-02-03 09:14:08
         compiled from "/home/cooltivoinfo/public_html/themes/electronic/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:128782772254d0d7b0237302-08560057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '744582ddc067fe2cdfef84ffc697758cd90c4032' => 
    array (
      0 => '/home/cooltivoinfo/public_html/themes/electronic/product.tpl',
      1 => 1422887833,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128782772254d0d7b0237302-08560057',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d0d7b0b91097_21435431',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d0d7b0b91097_21435431')) {function content_54d0d7b0b91097_21435431($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/cooltivoinfo/public_html/tools/smarty/plugins/function.counter.php';
?>
...
')"/>
	...
	<?php }?>
        <div class="row">
	<!-- right infos-->
	<div id="pb-left-column" class="col-sm-5 col-md-5 col-sms-12 col-smb-12">
		<!-- product img-->
		<div id="image-block">
		<?php if ($_smarty_tpl->tpl_vars['have_image']->value) {?>
			<span id="view_full_size">
				<img id="bigpic" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'pos_large'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
" />
		...
		<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>4) {?><span class="view_scroll_spacer"><a id="view_scroll_left" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
...
<?php }?>
	...
	<!-- left infos-->
	<div id="pb-right-column" class="col-sm-7 col-md-7 col-sms-12 col-smb-12">
...
<div id="more_info_block" class="clear">
	<ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
		<?php if ($_smarty_tpl->tpl_vars['product']->value->description) {?><li class="first"><a id="more_info_tab_more_info" href="#idTab1"><?php echo smartyTranslate(array('s'=>'More info'),$_smarty_tpl);?>
</a></li><?php }?>
...
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"qty=1&amp;id_product=".$_tmp4."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)."&amp;add"), ENT_QUOTES, 'ISO-8859-1', true);?>
