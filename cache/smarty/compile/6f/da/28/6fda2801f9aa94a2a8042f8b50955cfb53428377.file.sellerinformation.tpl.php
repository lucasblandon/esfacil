<?php /* Smarty version Smarty-3.1.19, created on 2015-02-03 03:07:04
         compiled from "/home/cooltivoinfo/public_html/modules/agilemultipleseller/views/templates/front/sellerinformation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:123690248354d081a84acfd6-73165765%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6fda2801f9aa94a2a8042f8b50955cfb53428377' => 
    array (
      0 => '/home/cooltivoinfo/public_html/modules/agilemultipleseller/views/templates/front/sellerinformation.tpl',
      1 => 1422891017,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123690248354d081a84acfd6-73165765',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d081a85c6037_73106167',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d081a85c6037_73106167')) {function content_54d081a85c6037_73106167($_smarty_tpl) {?><script type="text/javascript">
...
<?php } else { ?><?php echo htmlentities($_smarty_tpl->tpl_vars['sellerinfo']->value->postcode, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" type="text" />
    </div>
  </div>
</div>
...
" <?php if (isset($_POST['id_country'])) {?><?php if ($_POST['id_country']==$_smarty_tpl->tpl_vars['country']->value['id_country']) {?>selected="selected"<?php }?><?php } else { ?><?php if ($_smarty_tpl->tpl_vars['sellerinfo']->value->id_country==$_smarty_tpl->tpl_vars['country']->value['id_country']) {?>selected="selected"<?php }?><?php }?>><?php echo htmlentities($_smarty_tpl->tpl_vars['country']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
        <?php } ?>
      </select>
    </div>
...
<?php } else { ?><?php echo htmlentities($_smarty_tpl->tpl_vars['sellerinfo']->value->phone, ENT_QUOTES, 'UTF-8', true);?>
